...
export const starterExercises: Exercise[] = [
  ...
  { id: uid(), part: "胸", name: "スミスマシン・インクラインベンチプレス", measurementType: "reps" },
  ...
  { id: uid(), part: "腕", name: "ライイングトライセプスエクステンション", measurementType: "reps" },
  { id: uid(), part: "腕", name: "ディップス", measurementType: "reps" },
  { id: uid(), part: "腕", name: "オーバーヘッドトライセプスエクステンション", measurementType: "reps" },
];
